...
import sertif1 from '../assets/OGRN.jpg'
import sertif2 from '../assets/skan-tovarnogo-znaka.jpg'
import sertif3 from '../assets/deklaratsiya.jpg'
...
6)Получаете свою покупку.
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
          <img className="nav-sert" src={sertif1} />
          <img className="nav-sert" src={sertif2} />
          <img className="nav-sert" src={sertif3} />
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel4a-header"
        >
          <Typography>Как с нами связаться?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
